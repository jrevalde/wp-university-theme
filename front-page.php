        ...
        <div class="full-width-split__inner">
          ...
          ?>
            <div class="event-summary">
              ...
              <div class="event-summary__content">
                <h5 class="event-summary__title headline headline--tiny"><a href="<?php the_permalink( ); ?>"><?php the_title(); ?></a></h5>
                <p><?php echo wp_trim_words(the_content(), 18); ?><a href="<?php the_permalink( ); ?>" class="nu gray">Read more</a></p>
              </div>
            </div>
          <?php
          } wp_reset_postdata( ); //good to get into the habit of cleaning up data after creating custom query.
          ?>
